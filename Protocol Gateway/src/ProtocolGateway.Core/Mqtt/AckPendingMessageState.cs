...
namespace Microsoft.Azure.Devices.ProtocolGateway.Mqtt
{
    ...
    {
        public AckPendingMessageState(Message message, PublishPacket packet, string clientId = null)
            : this(message.MessageId, packet.PacketId, packet.QualityOfService, message.LockToken, clientId)
        {
        }

        public AckPendingMessageState(string messageId, int packetId, QualityOfService qualityOfService, string lockToken, string clientId)
        {
